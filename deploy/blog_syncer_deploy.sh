#!/usr/bin/env bash
# 配置项（根据需要修改）
PROJECT_NAME="blog-syncer"
REPO_URL="https://github.com/chaorenex1/blog-syncer"
BRANCH="main"
...
docker run -d \
  ...
  -v "${LOG_HOST_DIR}/aduib_blog_syncer.log:/app/aduib_blog_syncer.log" \
  "${IMAGE_TAG}"
